...
TURKISH_BY_AUTHORITY = {
    ...
    "msgNumber": 900,
    "navArea": "A",
    "authority": "TURKEY NAVTEX 615/20",
...
def test_a_four_corner_area_fills_the_cells_between_its_corners():
    cells = msi._cells_of(navtex.positions(
