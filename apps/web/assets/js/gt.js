...
(function () {
  ...
  Object.assign(I18N.tr, {
    ...
    't.stat.totalTip': '{n} ayın toplamı',
    't.stat.absent': 'Raporlanmış yokluk ayı',
    't.stat.silentTip': 'Ayrıca {n} ayda Türkiye Comtrade’e hiç yayın yapmadı; o aylar sayılmaz.',
    ...
    't.note': 'Yasaktan sonraki {d} ayın {n} tanesinde İsrail, Türkiye menşeli ithalat kaydetti; toplamı {v}. Aynı ayların hiçbirinde Türkiye’nin beyanlarında İsrail satırı yoktur. Bunların {r} tanesinde Türkiye aynı ay başka ortaklarını raporlamıştır: o aylardaki yokluk raporlanmış bir yokluktur ve {q} tutarını kapsar.',
    't.noteSilent': 'Kalan {n} ayda Türkiye Comtrade’e hiç yayın yapmamıştır. Bu bir yokluk değil, sessizliktir; o aylar hakkında bu seri bir şey söylemez.',
    ...
    't.flagk': 'Bayrak',
    't.flag': 'Bayrak değişikliği belgelenebilir mi?',
    't.flaglead': 'Evet — ve hiçbir şey izlemeden. İki otorite, yaptırım uyguladığı geminin taşıdığı bayrağı ve daha önce taşıdığı bayrağı yayımlıyor.',
    't.flagnot': 'Bu, yukarıdaki ticaret serisinden farklı bir listedir ve İsrail ticareti hakkında hiçbir şey söylemez. Burada gösterilen şey, bir geminin hangi sicili bırakıp hangisine geçtiğinin resmî kaynaklarda kayıtlı olduğudur — yani sorunun yöntemi. Konum, rota ve mürettebat bu dosyada hiç yoktur ve olmayacaktır.',
    't.f.listed': 'Yaptırım listelerindeki gemi',
    't.f.changed': 'Kayıtlı önceki bayrağı olan gemi',
    't.f.watch': 'İzleme bölgelerine değen gemi',
    't.f.imo': 'IMO numarası kayıtlı gemi',
    't.f.from': 'Bıraktığı bayrak',
    't.f.to': 'Geçtiği bayrak',
    't.f.count': 'Gemi',
    't.f.src': 'Kaynak: OFAC Özel Olarak Belirlenmiş Kişiler listesi (ABD hükümeti eseri, kamu malı) ve BM Güvenlik Konseyi birleşik listesi. Bayrak adları kaynağın kendi yazımıyla verilir. Üretim: {at}.',
    'nav.sea': 'Deniz',
    'nav.air': 'Hava',
    'h.title': 'Hava paneli',
    'h.mapAria': 'Türkiye çevresindeki uçuş bilgi bölgeleri (FIR). Şematiktir; seyrüsefer için kullanılamaz.',
    'h.seas': 'Denizlerin hava sahası',
    'h.firs': 'Uçuş bilgi bölgeleri',
    'h.count': '{n} bölge',
    'h.src': 'FIR kaynakları',
    'h.st.firs': 'Haritadaki FIR',
    'h.st.aegean': 'Ege kutusunda en büyük pay',
    'h.st.tur': 'Türk FIR\'larının alanı',
    'h.st.seas': 'Ölçülen deniz',
    'h.pulse': 'Veri {at}',
    'h.warn': 'Bu sınırlar şematiktir. Açık lisanslı bir topluluk veri kümesinden gelir, resmî bir havacılık kaynağı değildir; bir sınırın yetkili kaynağı ilgili devletin AIP\'sidir. Seyrüsefer için kullanılamaz ve bir sınırın hukuken nerede geçtiğine delil sayılamaz.',
    'h.seasNote': 'Bir FIR, bir devletin hava trafik hizmeti verdiği alandır; egemenlik değildir ve bir iddia değildir. ICAO tarafından tahsis edilir, su üstünü ve başka devletlerin kıyısını kapsayabilir. Hava sahası cevabı ile altındaki denize ilişkin cevap aynı şey değildir ve farklı zeminlerde tartışılır. Bir satıra basmak haritayı o denize götürür.',
    'h.tipArea': '{n} km² · şematik sınır',
    'h.schematicShort': 'şematik sınır',
    'h.unaccounted': 'Kutunun %{n} kadarı listelenen FIR\'ların dışında kalır (kara ya da kapsanmayan alan).',
    'h.lg.fir': 'Uçuş bilgi bölgesi (şematik)',
    'h.lg.on': 'Seçili bölge',
    'h.lg.land': 'Kara',
    'n.title': 'Deniz paneli',
    'n.situation': 'Durum',
    'n.seas': 'Denizler',
    'n.clear': 'Seçimi kaldır',
    'n.col.sea': 'Deniz',
    'n.col.act': 'Faaliyet ’15–’21',
    'n.col.sites': 'Tesis',
    'n.seasNote': 'İlan edilen askerî faaliyet, 2015–2021; yabancı seyir ihbarlarından. Türk ihbarları sayılmaz. Bir satıra basmak o denize götürür.',
    'n.how': 'Nasıl sayılıyor?',
    'n.layers': 'Katmanlar',
    'n.l.jur': 'Deniz yetki alanları',
    'n.l.straits': 'Boğazlar ve iç sular',
    'n.l.lic': 'KKTC ruhsat sahaları',
    'n.l.act': 'İlan edilen faaliyet',
    'n.l.actNote': 'Yoğunluk yüzeyi: 0,25° (≈21 km) ızgaradaki sayımlar yumuşatılıp bantlara ayrılmıştır. Bantlar arasındaki sınır bir olayın bittiği yer değil, çizim eşiğidir.',
    'n.l.isl': 'Türk adaları',
    'n.l.sites': 'Ege sicili',
    'n.records': 'Sicil kayıtları',
    'n.count': '{n} kayıt',
    'n.none': 'Bu denizde kayıt yok.',
    'n.st.act': 'İlan edilen askerî faaliyet',
    'n.st.sites': 'Sicildeki tesis',
    'n.st.flags': 'Kayıtlı bayrak değişikliği',
    'n.st.sea': 'Durdurulan ticarette denizyolu payı',
    'n.pulse': 'Veri {at} · faaliyet penceresi {w}',
    'n.seaTip': '{c} ızgara hücresi',
    'n.lg.site': 'Sicil kaydı',
    'n.lg.unc': 'Hata payı dairesi',
    'n.d.at': 'Koordinat',
    'n.d.unc': 'Hata payı',
    'n.d.method': 'Yöntem',
    's.eyebrow': 'Deniz paneli',
    's.title': 'Denizde ne var, ne ilan ediliyor',
    's.lead': 'Türkiye\'nin deniz yetki alanları, Boğazlar ve adalar; üstünde 2015–2021 arasında başka devletlerin denizcilere ilan ettiği faaliyetin ızgarası. Altında üç okuma: hangi denizde ne ilan edildi, hangi gemiler hangi sicili bırakıp hangisine geçti, ve durdurulan İsrail ticaretinin ne kadarı denizden gidiyordu.',
    's.mapTitle': 'Harita',
    's.mapAria': 'Türkiye\'nin deniz yetki alanları, Boğazlar, Türk adaları ve ilan edilen deniz faaliyetinin ızgarası.',
    's.reset': 'Sıfırla',
    's.loading': 'Yükleniyor…',
    's.err': 'Katmanlar yüklenemedi.',
    's.lg.agreed': 'Anlaşmayla belirlenmiş',
    's.lg.claimed': 'Türkiye\'nin bildirdiği sınır',
    's.lg.straits': 'Boğazlar ve iç sular',
    's.lg.cell': 'İlan edilen faaliyet yoğunluğu (2015–2021)',
    's.lg.licence': 'KKTC ruhsat sahaları',
    's.lg.island': 'Türk adası',
    's.readTitle': 'Okunanlar',
    's.seas': 'Hangi denizde ne ilan edildi',
    's.cells': '{n} hücre',
    's.seaTip': '{n} ihbar (askerî ve diğer)',
    's.seasNote': 'Askerî sınıflı ihbar sayısı, 2015–2021. Bir hücre, merkezi o denizin kutusunda kalıyorsa sayılır. Türk ihbarları hiçbir sütunda sayılmaz.',
    's.flags': 'Bayrak değişiklikleri',
    's.flagsNote': 'Yaptırım listelerindeki {t} geminin {n} tanesinde önceki bayrak kayıtlı. Kaynak, otoritelerin kendi yayımladığı künyedir; hiçbir geminin konumu burada yoktur.',
    's.trade': 'Durdurulan ticaret denizden gidiyordu',
    's.tr.share': 'Yasaktan önce denizyolu payı',
    's.tr.monthly': 'Aylık ortalama, denizyoluyla',
    's.tr.months': 'Ölçülen ay',
    's.tradeNote': 'Türkiye\'nin kendi beyanından, yasak öncesi aylar. İsrail\'in beyanlarında taşıma türü kırılımı yoktur, bu yüzden yasak sonrası için aynı pay hesaplanamaz.',
    's.srcNote': 'Bu sayfada hiçbir geminin konumu, rotası, tahminî varışı veya mürettebatı yoktur; böyle bir alan hiç tanımlanmamıştır. Deniz alanları Türkiye\'nin resmî bildirimlerine dayanır ve her katmanın kaynağı aşağıdadır.',
    's.src.maritime': 'Deniz alanları kaynakları',
    's.src.msi': 'İlan edilen faaliyet kaynakları',
    's.src.trade': 'Ticaret ve gemi kimliği kaynakları',
    't.goodsk': 'Ürünler',
    't.goods': 'Hangi mallar gidiyor?',
    't.goodslead': 'İsrail’in kendi beyanından, armonize sistem faslı bazında: yasaktan önceki 12 ayın ve sonraki 12 ayın aylık ortalaması. İki pencere de aynı raportörden okunur.',
    't.goodsnote': 'Fasıl geniş bir kategoridir; “demir ve çelik” tek bir ürün değildir. ▲ işaretli satır bir akış değil, tek bir teslimattır: penceredeki değerin neredeyse tamamı tek ayda kayıtlıdır. Rakamlar neyin vardığını söyler; hangi yoldan ya da hangi gemiyle geldiğini söylemez.',
    't.g.open': 'aç',
    't.g.headNote': 'Bir fasla basmak onu dört haneye açar. Fasıl geniş bir kategoridir: inşaat demiri ile fabrika sacı aynı fasılda yer alır ve aynı soruyu yanıtlamaz. Yalnızca en çok taşıyan fasıllar açılabilir.',
    't.g.chapter': 'Fasıl',
    't.g.before': 'Önce (aylık ort.)',
    't.g.after': 'Sonra (aylık ort.)',
    't.g.share': 'Değişim',
    't.g.lumpyTip': 'Penceredeki 12 ayın yalnızca {n} tanesinde kayıt var; değer tek bir teslimata yığılmış.',
    't.g.src': 'Kaynak: UN Comtrade, raportör İsrail, ortak Türkiye, ithalat. Pencereler: {b} ve {a}. Tüm fasılların toplamı {was}/ay iken {now}/ay.',
    ...
    'p.pulse': 'Veri {at} · {e} olay · {s} tesis · {src} kaynak',
    'p.oneSource': 'tek kaynak',
    ...
    'p.board.activity': 'Faaliyet ’15–’21', 'p.board.last': 'Son', 'p.board.clear': 'Seçimi kaldır',
  ...
  Object.assign(I18N.en, {
    ...
    't.stat.totalTip': 'total over {n} months',
    't.stat.absent': 'Months of reported absence',
    't.stat.silentTip': 'In a further {n} months Türkiye published nothing at all to Comtrade; those are not counted.',
    ...
    't.note': 'In {n} of the {d} months since the halt Israel recorded imports of Turkish origin, {v} in total. In none of those months do Türkiye’s returns carry an Israel line. In {r} of them Türkiye reported other partners that same month, so the absence is a reported one, and it covers {q}.',
    't.noteSilent': 'In the remaining {n} months Türkiye published nothing at all to Comtrade. That is silence rather than absence, and this series says nothing about those months.',
    ...
    't.flagk': 'Flag',
    't.flag': 'Can a reflagging be documented?',
    't.flaglead': 'It can, and without watching anything: two authorities publish the flag a designated ship flies and the flag it used to fly.',
    't.flagnot': 'This is a different list from the trade series above and says nothing about the Israel trade. What it shows is that the registry a ship left and the one it joined are on the record — the method behind the question. Position, route and crew are not in this file and never will be.',
    't.f.listed': 'Vessels on the sanctions lists',
    't.f.changed': 'Vessels with a former flag recorded',
    't.f.watch': 'Vessels touching the watch regions',
    't.f.imo': 'Vessels with an IMO number recorded',
    't.f.from': 'Flag left',
    't.f.to': 'Flag joined',
    't.f.count': 'Vessels',
    't.f.src': 'Sources: the OFAC Specially Designated Nationals list (a work of the US Government, public domain) and the UN Security Council consolidated list. Flag names are given as the source writes them. Built {at}.',
    'nav.sea': 'Sea',
    'nav.air': 'Air',
    'h.title': 'Air dashboard',
    'h.mapAria': 'Flight information regions around Türkiye. Schematic; not for navigation.',
    'h.seas': 'The seas\' airspace',
    'h.firs': 'Flight information regions',
    'h.count': '{n} regions',
    'h.src': 'FIR sources',
    'h.st.firs': 'FIRs on the map',
    'h.st.aegean': 'Largest share of the Aegean box',
    'h.st.tur': 'Area of the Turkish FIRs',
    'h.st.seas': 'Seas measured',
    'h.pulse': 'Data {at}',
    'h.warn': 'These boundaries are schematic. They come from an openly licensed community dataset, not from an aeronautical source; the authority for a boundary is the relevant state\'s AIP. They may not be used for navigation, nor as evidence of where a boundary legally runs.',
    'h.seasNote': 'A FIR is where a state provides air traffic services. It is not sovereignty and it is not a claim: ICAO assigns it, and it may cover water and other states\' coasts. The airspace answer and the answer about the sea beneath it are different, and are argued on different grounds. A row takes the map to that sea.',
    'h.tipArea': '{n} km² · schematic boundary',
    'h.schematicShort': 'schematic boundary',
    'h.unaccounted': '{n} of the box falls outside the listed FIRs (land, or airspace none of them covers).',
    'h.lg.fir': 'Flight information region (schematic)',
    'h.lg.on': 'Selected region',
    'h.lg.land': 'Land',
    'n.title': 'Sea dashboard',
    'n.situation': 'Situation',
    'n.seas': 'The seas',
    'n.clear': 'Clear selection',
    'n.col.sea': 'Sea',
    'n.col.act': 'Activity ’15–’21',
    'n.col.sites': 'Sites',
    'n.seasNote': 'Military activity announced in other states\' navigational warnings, 2015–2021; Turkish warnings are not counted. A row takes the map to that sea.',
    'n.how': 'How is it counted?',
    'n.layers': 'Layers',
    'n.l.jur': 'Maritime jurisdiction',
    'n.l.straits': 'The Straits and internal waters',
    'n.l.lic': 'TRNC licence blocks',
    'n.l.act': 'Announced activity',
    'n.l.actNote': 'A density surface: counts on a 0.25° (about 21 km) grid, smoothed and cut into bands. A band edge is a drawing threshold, not a line where anything stopped.',
    'n.l.isl': 'Turkish islands',
    'n.l.sites': 'The Aegean register',
    'n.records': 'Register records',
    'n.count': '{n} records',
    'n.none': 'No record in this sea.',
    'n.st.act': 'Military activity announced',
    'n.st.sites': 'Sites in the register',
    'n.st.flags': 'Flag changes on the record',
    'n.st.sea': 'Share of the halted trade that went by sea',
    'n.pulse': 'Data {at} · activity window {w}',
    'n.seaTip': '{c} grid cells',
    'n.lg.site': 'Register record',
    'n.lg.unc': 'Uncertainty circle',
    'n.d.at': 'Coordinate',
    'n.d.unc': 'Uncertainty',
    'n.d.method': 'Method',
    's.eyebrow': 'The sea panel',
    's.title': 'What is at sea, and what is announced there',
    's.lead': 'Türkiye\'s maritime jurisdiction, the Straits and the islands, under a grid of the activity other states announced to mariners between 2015 and 2021. Three readings below it: what was announced in which sea, which registries ships left and joined, and how much of the halted Israel trade used to move by water.',
    's.mapTitle': 'Map',
    's.mapAria': 'Türkiye\'s maritime jurisdiction, the Straits, Turkish islands and the grid of announced activity at sea.',
    's.reset': 'Reset',
    's.loading': 'Loading…',
    's.err': 'The layers could not be loaded.',
    's.lg.agreed': 'Delimited by agreement',
    's.lg.claimed': 'Limit notified by Türkiye',
    's.lg.straits': 'The Straits and internal waters',
    's.lg.cell': 'Announced activity, as density (2015–2021)',
    's.lg.licence': 'TRNC licence blocks',
    's.lg.island': 'Turkish island',
    's.readTitle': 'Readings',
    's.seas': 'What was announced in which sea',
    's.cells': '{n} cells',
    's.seaTip': '{n} warnings (military and other)',
    's.seasNote': 'Warnings classed as military, 2015–2021. A cell counts for a sea when its centre falls inside that sea\'s box. Turkish warnings are not counted in any column.',
    's.flags': 'Changes of flag',
    's.flagsNote': 'Of the {t} vessels on the sanctions lists, {n} carry a former flag on the record. The source is the particulars the authorities publish themselves; no vessel\'s position is here.',
    's.trade': 'The halted trade went by sea',
    's.tr.share': 'Share carried by sea before the halt',
    's.tr.monthly': 'Monthly average, by sea',
    's.tr.months': 'Months measured',
    's.tradeNote': 'From Türkiye\'s own returns, for the months before the halt. Israel\'s returns carry no mode-of-transport split, so the same share cannot be computed for the months after it.',
    's.srcNote': 'No vessel\'s position, route, estimated arrival or crew is on this page; no such field was ever defined. The maritime areas follow Türkiye\'s official notifications and every layer\'s source is below.',
    's.src.maritime': 'Maritime area sources',
    's.src.msi': 'Announced activity sources',
    's.src.trade': 'Trade and vessel identity sources',
    't.goodsk': 'Goods',
    ...
    't.g.chapter': 'Chapter',
    't.g.before': 'Before (monthly avg)',
    't.g.after': 'After (monthly avg)',
    't.g.share': 'Change',
    't.g.lumpyTip': 'Recorded in only {n} of the twelve months: the value sits in a single delivery.',
    't.g.src': 'Source: UN Comtrade, reporter Israel, partner Türkiye, imports. Windows: {b} and {a}. All chapters together fell from {was} a month to {now}.',
    ...
    'p.pulse': 'Data built {at} · {e} events · {s} sites · {src} sources',
    'p.oneSource': 'one source',
    ...
    'p.board.activity': 'Activity ’15–’21', 'p.board.last': 'Newest', 'p.board.clear': 'Clear selection',
