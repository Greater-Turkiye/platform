...
| `data/msi-activity.json`, `data/msi-density.json` | [NGA Maritime Safety Information](https://msi.nga.mil/NavWarnings) broadcast warnings — counted, classified and gridded by us, no warning text copied | accessed 2026-09-19 | Work of the United States Government: public domain — see `data/MSI-ACTIVITY-SOURCES.md` |
