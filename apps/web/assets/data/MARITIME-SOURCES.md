...
| `tur-kktc-med-merged` (bkz. / see [KKTC](#kktc-ruhsat-sahaları--trnc-licence-areas)) | MultiPolygon | ≈ 194 200 km² | 770 | 3, 4 |
...
| `tur-kktc-med-merged` | — | — | — | ≈ 194,181 km² | 770 (3 parça / parts, 4 delik / holes) |
...
Sonuç: 3 parça (ana alan, Erenköy çevresi ve `tur-med-schematic`'ten gelen 140 km²'lik bir parça), 4 delik, 770 köşe, ≈ **194 181 km²** (önceki 192 293 km²; +1 888 km²). Önizleme: `tools/geo/kktc-preview.png`.
...
Result: 3 parts (the main area, the part around Erenköy, and a 140 km² part inherited from `tur-med-schematic`), 4 holes, 770 vertices, ≈ **194,181 km²** (previously 192,293 km²; +1,888 km²). Preview: `tools/geo/kktc-preview.png`.
...
- `maritime-tur.geojson`: 15 features, 3,410 vertices (5 original features: 975; 2 schematic areas: 1,573; 7 TRNC licence areas: 92; merged Türkiye + TRNC area: 770); every geometry `is_valid`; ≤ 4 decimals. Original features: exterior ring counter-clockwise, holes clockwise. Schematic areas, licence areas and the merged area: exterior clockwise, holes counter-clockwise. A full `build_maritime.py` run reproduces the committed `maritime-tur.geojson` and `islands-tur.geojson` byte for byte.
