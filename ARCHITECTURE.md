...
| Cloudflare Workers | Günde 100.000 istek; çağrı başına 10 ms CPU / 100,000 requests per day; 10 ms CPU per invocation | api, review-bot, scheduler, publisher, web |
